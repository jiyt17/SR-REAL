...
class LLMEngine:
    ...
    def _add_processed_request(
        ...
        """
        # processed_inputs : {"prompt_token_ids": list(raw_prompt_ids[0]), "multi_modal_data": inputs_embeds}
        if isinstance(params, SamplingParams) and params.n > 1:
            ...
            return None
        if is_embedded:
            self._validate_model_inputs(processed_inputs["prompt_token_ids"], lora_request, is_embedded)
        else:
            self._validate_model_inputs(processed_inputs, lora_request, is_embedded)
        ...
        if is_encoder_decoder_inputs(processed_inputs):
            ...
            decoder_inputs = {}
            decoder_inputs["prompt_token_ids"] = processed_inputs["prompt_token_ids"]
            decoder_inputs["prompt_embeds"] = processed_inputs["multi_modal_data"]
            decoder_inputs["type"] = "embedding"
            decoder_inputs["token_type_ids"] = None
            encoder_inputs = None
        else:
    ...
    def add_request(
        ...
        # prompt : {"prompt_token_ids": list(raw_prompt_ids[0]), "multi_modal_data": inputs_embeds}
        self._add_processed_request(
            ...
            trace_headers=trace_headers,
            priority=priority,
            is_embedded="is_embedded" in prompt.keys()
        )
    ...
    def _validate_model_inputs(self, inputs: ProcessorInputs,
                               lora_request: Optional[LoRARequest], is_embedded: bool = False) -> None:
