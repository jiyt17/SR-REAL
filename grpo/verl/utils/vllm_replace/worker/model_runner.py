...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    def _compute_lens(self, inter_data: InterDataForSeqGroup, seq_idx: int,
        ...
        if seq_data.prompt_embeds is None or len(seq_data.output_token_ids) != 0:
            tokens = seq_data.get_token_ids()[context_len:seq_len]
            prompt_embeds = None
        else:
    ...
    def add_seq_group(self, seq_group_metadata: SequenceGroupMetadata):
        ...
        ### here to determine the specific number of block tables
    ...
    def build(self) -> ModelInputForGPU:
        ...
        if len(inputs_embeds_) == 0:
            ...
            # processed_embeds = [embed.squeeze(0) for embed in inputs_embeds_]
        ...
        for inter_data in self.inter_data_list:
            ...
            # seq_lens.extend(inter_data.inputs_embeds)
            # query_lens.extend(inter_data.query_lens)
