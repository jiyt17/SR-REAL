...
class SequenceData(msgspec.Struct,
    ...
    def get_len(self) -> int:
        #if self._prompt_embeds:
        #    return len(self._output_token_ids) + self._prompt_embeds.shape[0]
...
class ParallelSampleSequenceGroup(SequenceGroupBase):
    ...
    @staticmethod
    def add_request(request_id: str, engine, params, is_embedded, **kwargs):
