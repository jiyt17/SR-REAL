...
def prepare_config_for_training(
    ...
    if getattr(config, "perception_encoder_cfg", None) is None:
        config.perception_encoder_cfg = model_args.perception_encoder
    # set default dtype
    ...
    config.tune_perception_encoder = training_args.tune_perception_encoder
    # set data args
